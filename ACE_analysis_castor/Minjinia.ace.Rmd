...
Extracting the AICs, logged likelihood (global) and the scaled likelihood for each state at the node of interest (MRCA between _Minjinia_ and _Helodus_) for all the ancestral character estimations.s
